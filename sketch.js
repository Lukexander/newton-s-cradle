...
function setup() {
  ...
  pendulum1 = new Pendulum(340, 450, "#0019ff");
  pendulum2 = new Pendulum(400, 450, "#0019ff");
  pendulum3 = new Pendulum(460, 450, "#0019ff");
  pendulum4 = new Pendulum(520, 450, "#0019ff");
  pendulum5 = new Pendulum(580, 450, "#0019ff");
  ...
  ground = new Ground(460,200,400,50)
}
